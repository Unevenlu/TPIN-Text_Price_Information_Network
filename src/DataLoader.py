...
from NewModel import creat_mask
import torch
...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        mask = creat_mask(n_msgs).reshape(global_config['max_n_days'],-1) #(5,30)
        ...
        return word, main_y, price, other_price, T, mask
    ...
    def get_all(self):
        ...
        sample_list = data_pipe.generator2list(generators, phase)
        return sample_list
